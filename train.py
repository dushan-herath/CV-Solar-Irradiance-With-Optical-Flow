...
if __name__ == "__main__":
    ...
    # --- Model setup ---
    sky_encoder = ImageEncoder(model_name="vit_large_patch16_224.mae", pretrained=True, freeze=True, unfreeze_last=2)
    flow_encoder = ImageEncoder(model_name="vit_large_patch16_224.mae", pretrained=True, freeze=True, unfreeze_last=2)
